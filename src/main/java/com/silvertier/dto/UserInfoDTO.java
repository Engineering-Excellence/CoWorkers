...
public class UserInfoDTO {
	...
	private int registerNumber; // UK, 주민등록번호 -- 회원가입 시 주민등록번호 유효성 검사 + 탈퇴 시 이용
	private int mobileNumber; // UK, 휴대폰 번호 -- 회원가입 시 인증 및 ID/PW 찾기 용도
	...
	public String toString() {
		return "UserInfoDTO [userID=" + userID + ", accountID=" + accountID + ", accountPassword=" + accountPassword
				...
				+ ", gender=" + gender + ", email=" + email + ", retireDate=" + retireDate + ", positionCode="
				+ positionCode + "]";
	}
